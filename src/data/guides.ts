...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Revealed romance candidates", content: "At least four candidates have been revealed by official and reported character announcements. This is not presented as the final roster.", sourceLevel: "L2", sourceUrl: "https://meowdb.com/db/witchbrook", bullets: ["Hana Sato — upbeat energy linked to the Calico fashion shop", "Pip — witch-mechanic working from a harbour garage", "Cormac — gifted artist associated with The Briny Brush", "Eli — Oracle editor with a School Shop connection"] },
