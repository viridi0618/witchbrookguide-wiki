...
export const guides: Guide[] = [
  {
    ...
    priority: "P0",
    dek: "2026. That's all Chucklefish will say right now - and honestly, after a decade of waiting, that restraint is probably a good sign.",
  ...
  },
  {
    ...
    priority: "P0", dek: "Five console families people keep asking about. Four are real. Here's which ones to plan around.", image: "/images/college.png", imageAlt: "Witchbrook character meeting Professor Carlyle outside a woodland cottage",
  ...
  {
    slug: "switch-2", title: "Witchbrook on Switch 2: Confirmed Day-One Launch in 2026", metaDescription: "Witchbrook is confirmed for Nintendo Switch 2 as a day-one launch alongside PC, Switch, and Xbox. See the announcement and what remains unknown.", h1: "Witchbrook Switch 2", intent: "Day-one status and confirmed Switch 2 information.", priority: "P0", dek: "You won't need to buy the game twice or wait six months for a 'Switch 2 enhanced edition.' Day one means day one.", image: "/images/assignments.png", imageAlt: "Witchbrook students completing a magical college assignment",
  ...
  {
    slug: "xbox", title: "Witchbrook on Xbox: Series X|S, Xbox One & Co-op Guide", metaDescription: "Witchbrook is confirmed for Xbox One and Xbox Series X|S. See listed 4K, Smart Delivery, cross-platform co-op, achievements, and Game Pass status.", h1: "Witchbrook on Xbox", intent: "Xbox versions, store capabilities, co-op, and Game Pass clarification.", priority: "P0", dek: "Xbox players get the most detailed pre-launch spec sheet of any platform. Whether that means 120 fps is the real question.", image: "/images/business.png", imageAlt: "Witchbrook order board used to manage a witchy business",
  ...
  {
    slug: "multiplayer", title: "Witchbrook Multiplayer & Co-op: Players and Split-Screen", metaDescription: "Witchbrook supports one to four players in online co-op. Learn about player count, no split-screen, Xbox cross-platform play, and co-op activities.", h1: "Witchbrook Multiplayer", intent: "Player count, online-only status, and confirmed co-op activities.", priority: "P0", dek: "Don't worry about other freshmen judging your broomstick landings. They're probably offline.", image: "/images/hero.png", imageAlt: "A group of witches gathered inside Witchbrook College",
  ...
  {
    slug: "steam", title: "Witchbrook on Steam: Wishlist & System Requirements", metaDescription: "The Witchbrook Steam page is live. See minimum PC requirements, online co-op, achievements, cloud saves, languages, and the official wishlist link.", h1: "Witchbrook on Steam", intent: "Steam features, wishlist link, and current PC requirements.", priority: "P0", dek: "Hit wishlist, check your specs, then settle in. The requirements are refreshingly modest for a game this ambitious.", image: "/images/classes.png", imageAlt: "Students attending a practical tea class at Witchbrook College",
  ...
  {
    slug: "assignments", title: "Witchbrook Assignments: Merits, Tasks & Exams Explained", metaDescription: "Learn how Witchbrook assignments work: take weekly college tasks, research solutions, help Mossport residents, earn merits, and qualify for exams.", h1: "Witchbrook Assignments", intent: "The complete confirmed assignment-to-exam loop.", priority: "P1", dek: "Forget pop quizzes. Witchbrook makes you leave the classroom, talk to real townsfolk, and actually solve someone's problem to pass.", image: "/images/assignments.png", imageAlt: "Witchbrook students working together on a college assignment",
  ...
  {
    slug: "witchy-business", title: "Witchbrook Witchy Business: Start Your Magic Shop Guide", metaDescription: "See how Witchbrook's magic business works: fulfill Mossport orders, unlock client perks, deliver by moped or broom, and sell at Sunday markets.", h1: "Witchbrook Witchy Business", intent: "The confirmed business loop and its links to college progression.", priority: "P1", dek: "Your cottage familiar Fable has a plan. It involves orders, deliveries, and a broom license - and your covenmate is definitely taking a cut.", image: "/images/business.png", imageAlt: "Witchbrook business order board with requests from Mossport residents",
  ...
  {
    slug: "games-like-witchbrook", title: "10 Games Like Witchbrook: Cozy Magic & Witch Life Sims", metaDescription: "Play 10 games like Witchbrook while you wait: cozy magic-school adventures, witch life sims, alchemy games, farming RPGs, and supernatural worlds.", h1: "Games Like Witchbrook", intent: "Ten adjacent games organized by the fantasy they share.", priority: "P2", dek: "Witchbrook isn't out yet. These 10 will keep you company until it is — and honestly, a couple of them might ruin other cozy games for you.", image: "/images/college.png", imageAlt: "The green woodland cottage area outside Witchbrook College",
  ...
  {
    slug: "faq", title: "Witchbrook FAQ: Release, Platforms, Co-op & Romance", metaDescription: "Answers to common Witchbrook questions about the 2026 release, platforms, online co-op, split-screen, romance, classes, business, price, and more.", h1: "Witchbrook FAQ", intent: "A concise answer hub for every major pre-launch question.", priority: "P2", dek: "Release date. Platforms. Romance. Co-op. Price. All the questions you'd ask before packing your bags for Mossport.", image: "/images/hero.png", imageAlt: "Witchbrook College hall filled with aspiring witches",
